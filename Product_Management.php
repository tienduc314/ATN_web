    ...
    <link rel="stylesheet" href="css/bootstrap.min.css">
        ...
        <table id="tableproduct" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <?php
                ...
                $No=1;
                $result = pg_query($conn, "SELECT product_id, product_name, price, pro_qty, pro_image, cat_name, shop_name FROM public.product 
                JOIN public.category ON (product.cat_id = category.cat_id) 
                JOIN public.shop ON (product.shop_id = shop.shop_id)");
