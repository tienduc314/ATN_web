			...
			if($pic['type']=="image/jpg" || $pic['type']=="image/jpeg" || $pic['type']=="image/png" || $pic['type']=="image/gif"){
				if($pic['size'] <= 614400)
				{
					...
					if(pg_num_rows($result)==0)
					{
						...
						$filePic = $pic['name'];
						$sqlstring = "INSERT INTO product(product_id, product_name, price, oldprice, smalldesc, detaildesc, prodate, pro_qty, pro_image, cat_id)
						VALUE ('$id', '$proname', $price, '$oldprice', '$short', '$detail', '".date('Y-m-d H:i:s')."',$qty, '$filePic', '$category')";
